...
ig.Entity.checkPair = function( a, b ) {
	...
	if(
		...
		//a.collides + b.collides > 7//ig.Entity.COLLIDES.ACTIVE
		(a.paddle && b.ball) ||
		(a.ball && b.paddle) ||
		(a.soldier && b.soldier && a.controller != b.controller) ||
		(a.soldier && b.paddle && a.controller != b.controller) ||
		(a.paddle && b.soldier && a.controller != b.controller) ||
		(a.miner && b.scorebox && a.controller != b.controller) ||
		(a.scorebox && b.miner && a.controller != b.controller)
	) {
